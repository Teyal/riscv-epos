...
template<> struct Traits<CPU>: public Traits<Build>
{
    ...
    static const unsigned int CLOCK             = Traits<Build>::MODEL == Traits<Build>::Sifive ? 50000000 : Traits<Build>::MODEL == Traits<Build>::Zynq ? 666666687 : 32000000;
...
template<> struct Traits<TSC>: public Traits<Build>
{
    ...
    static const bool enabled = (Traits<Build>::MODEL != Traits<Build>::Sifive);
