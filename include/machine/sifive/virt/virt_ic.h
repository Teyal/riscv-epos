...
public:
    ...
    enum {
        INT_HARD_FAULT  = RISCV	_M::EXC_HARD,
        INT_SYS_TIMER   = RISCV	_M::EXC_SYSTICK,
...
public:
    ...
    static Interrupt_Id irq2int(Interrupt_Id id);
    static Interrupt_Id int2irq(Interrupt_Id irq);
